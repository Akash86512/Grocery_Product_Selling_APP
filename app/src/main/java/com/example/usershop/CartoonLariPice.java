...
public class CartoonLariPice extends AppCompatActivity {
    ImageView imageView;
    TextView txtname;
    TextView txtbrand;
    TextView txtprice;
    ...
    TextView txtonelariprice;
    TextView txtonelariweight;
    TextView txtonecartoonprice;
    TextView txtonecartoonweight; ElegantNumberButton elegantNumberButton,elegantNumberButton1;
    TextView numberoflari,lariprice;
    TextView numberofcartoon,cartoonprice;
    TextView totalprice,addtocartclp;
    ...
    String description;
    String onelariprice;
    String onelariweight;
    String onelariunit;
    String onecartoonprice;
    String onecartoonweight;
    String onecartoonunit,itemcategory,itemid;
    int total,sum1,sum2;
    int k=0;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_catoon_lari_pice);
        ...
        onelariprice=intent.getStringExtra("onelariprice");
        onelariweight=intent.getStringExtra("onelariquantity");
        onelariunit=intent.getStringExtra("onelariunit");
        ...
        txtonelariprice=findViewById(R.id.txtlariprice);
        txtonelariweight=findViewById(R.id.txtlariweight);
        txtonecartoonprice=findViewById(R.id.txtonecartoonprice);
        txtonecartoonweight=findViewById(R.id.txtonecartoonweight);
        numberoflari=findViewById(R.id.numberoflari);
        lariprice=findViewById(R.id.lariprice);
        numberofcartoon=findViewById(R.id.numberofcartoon);
        cartoonprice=findViewById(R.id.cartoonprice);
        totalprice=findViewById(R.id.totalprice);

        addtocartclp=findViewById(R.id.addtocartclp);
    ...
    txtonelariprice.setText("₹ "+onelariprice);
       txtonelariweight.setText(onelariweight+" "+onelariunit);
        ...
        elegantNumberButton.setOnValueChangeListener(new ElegantNumberButton.OnValueChangeListener() {
            ...
            public void onValueChange(ElegantNumberButton view, int oldValue, int newValue) {
                ...
                int p=Integer.parseInt(onelariprice);
                sum1=p*newValue;
                noofbox1=String.valueOf(newValue);
                numberoflari.setText(" "+newValue);
                lariprice.setText("₹ "+sum1);
                total=sum1+sum2;
        ...
        for(Addtocartitem b:list) {
            ...
            {
                addtocartclp.setText("Go To Cart");
                k=1;
            }

        }

        addtocartclp.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                if(k==0) {
                    ...
                    addtocartDB.insertdata(name, itemid, brand, Image, description, onelariprice, onelariweight, onelariunit, onecartoonprice, onecartoonweight, onecartoonunit, "", "", "", "",
        ...
        getSupportActionBar().setTitle("Cartoonlaripice");
        mToolbar.setTitleTextColor(Color.parseColor("#FFFFFF"));
        mToolbar.setNavigationIcon(R.drawable.ic_arrow_back_white_24dp);
        mToolbar.setNavigationOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(CartoonLariPice.this, SearchItem.class);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id==R.id.myCart){
            Intent i=new Intent(CartoonLariPice.this,MyCart.class);
            startActivity(i);
