...
public class RecyclerAdapterMyordeitemlist extends RecyclerView.Adapter<RecyclerAdapterMyordeitemlist.MyHolder> {
    ...
    public RecyclerAdapterMyordeitemlist(List<Addtocartitem> list, Context context) {
    ...
    public MyHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        View view = LayoutInflater.from(context).inflate(R.layout.myorderitemlist,parent,false);
